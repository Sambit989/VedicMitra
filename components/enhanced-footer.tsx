...
export function EnhancedFooter() {
  ...
  const trustIndicators = [
    ...
    { icon: Heart, text: "5000+ Happy Clients", color: "text-pink-400" },
  ]
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a
                    href="mailto:contact@vedicmitra.com"
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+919999999999" className="text-white hover:text-yellow-400 transition-colors">
                    +91 99999 99999
                  </a>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                ...
                <Button size="icon" variant="ghost" className="text-gray-400 hover:text-blue-400 hover:bg-blue-400/10">
