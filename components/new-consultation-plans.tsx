...
export function NewConsultationPlans() {
  const plans = [
    ...
    {
      number: "3",
      title: "Reiki Healing + Karma Cleansing + Aura Boost",
      price: 222,
      duration: "30-40 Minutes",
      whatsappText:
    ...
    },
    {
      ...
      features: [
        "Money blockage removal ritual",
        "Marriage or partner issue spell",
        "Relationship attraction spell",
        "Desire fulfillment ritual",
        "Simple instructions & aftercare guidance",
      ],
    },
  ]
