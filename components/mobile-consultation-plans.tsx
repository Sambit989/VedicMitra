...
export function MobileConsultationPlans() {
  const plans = [
    {
      duration: "12 Minutes",
      originalPrice: 249,
    ...
    <section className="py-12 px-4 relative z-10">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Choose Your Session & Get Instant Guidance</h2>
          <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto">
            Speak directly with a certified Vedic astrologer and get accurate readings in real-time.
          </p>
        </div>

        <div className="space-y-6 sm:grid sm:grid-cols-1 sm:gap-6 lg:grid-cols-3 lg:space-y-0">
            ...
            >
              ...
              <CardHeader className="text-center pb-4">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <CardTitle className="text-xl text-white">{plan.duration}</CardTitle>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-3xl font-bold text-yellow-400">₹{plan.finalPrice}</div>
                </div>
              </CardHeader>
